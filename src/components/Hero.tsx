      ...
      <div>
        ...
        <h1 className="text-4xl font-bold tracking-tight text-foreground sm:text-5xl">
          <span className="block">
            <span className="water-gradient bg-clip-text text-transparent">
              Tai Bui
            </span>
          </span>
        ...
        <div className="mt-4 inline-flex items-center gap-2 rounded-full bg-secondary/10 px-3 py-1 text-sm font-medium text-secondary border border-secondary/20 breathing-glow">
        ...
        <div className="mt-6 space-y-2">
          <div className="flex items-center gap-2 text-sm">
            ...
            <span className="text-muted">Water Breathing: AI/ML & Cloud Architecture</span>
          </div>
          <div className="flex items-center gap-2 text-sm">
            <div className="w-3 h-3 rounded bg-gradient-to-r from-orange-400 to-red-500 animate-pulse" />
            <span className="text-muted">Flame Breathing: Full-Stack Engineering</span>
          </div>
          <div className="flex items-center gap-2 text-sm">
            <div className="w-3 h-3 rounded bg-gradient-to-r from-purple-400 to-indigo-500 animate-pulse" />
            <span className="text-muted">Thunder Breathing: DevOps & Infrastructure</span>
          </div>
        </div>
